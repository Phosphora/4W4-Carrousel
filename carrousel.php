 ...
 * Author: Winnie Li
 * Author URI: https://github.com/Phosphora
 * Description: Une extension qui permet d'afficher les images d'une galerie dans une boîte modale naviguable 
 * Version: 1.0.0 */

 /* style.css pour formater et animer le carrousel */
 /* carrousel.js pour contrôler le carrousel */
 /* Une boîte modale qui contiendra le carrousel */
